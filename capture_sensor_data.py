...
SENSORS = [
    ...
    [
        'CameraBack',
        {
            'bp': 'sensor.camera.rgb',
            'image_size_x': 1280, 'image_size_y': 720, 'fov': 100,
            'x': -0.7, 'y': 0.0, 'z': 1.60, 'roll': 0.0, 'pitch': 0.0, 'yaw': 180.0
        },
    ],
    # [
    #     'CameraFrontLeft',
    ...
    #         'bp': 'sensor.camera.rgb',
    #         'image_size_x': 1280, 'image_size_y': 720, 'fov': 100,
    #         'x': 0.7, 'y': -0.7, 'z': 1.60, 'roll': 0.0, 'pitch': 0.0, 'yaw': 315.0
    #     },
    # ],
    # [
    #     'CameraFrontRight',
    ...
    #         'bp': 'sensor.camera.rgb',
    #         'image_size_x': 1280, 'image_size_y': 720, 'fov': 100,
    #         'x': 0.7, 'y': 0.7, 'z': 1.60, 'roll': 0.0, 'pitch': 0.0, 'yaw': 45.0
    #     },
    # ],
    # [
    #     'CameraBackLeft',
    ...
    #         'bp': 'sensor.camera.rgb',
    #         'image_size_x': 1280, 'image_size_y': 720, 'fov': 100,
    #         'x': -0.7, 'y': -0.7, 'z': 1.60, 'roll': 0.0, 'pitch': 0.0, 'yaw': 225.0
    #     },
    # ],
    # [
    #     'CameraBackRight',
    ...
    #         'bp': 'sensor.camera.rgb',
    #         'image_size_x': 1280, 'image_size_y': 720, 'fov': 100,
    #         'x': -0.7, 'y': 0.7, 'z': 1.60, 'roll': 0.0, 'pitch': 0.0, 'yaw': 135.0
    #     },
    # ],
    ...
    #         'x': 0.7, 'y': 0.0, 'z': 1.60, 'roll': 0.0, 'pitch': 0.0, 'yaw': 0.0,
    #         'range': 70, 'rotation_frequency': 10, 'channels': 32, 'upper_fov': 10,
    #         'lower_fov': -30, 'points_per_second': 400000, 'atmosphere_attenuation_rate': 0.004,
...
WEATHER = carla.WeatherParameters(
    sun_azimuth_angle=-1.0, sun_altitude_angle=70.0,
    cloudiness=30.0, precipitation=0.0, precipitation_deposits=80.0, wetness=0.0,
    wind_intensity=10.0,
    fog_density=2.0, fog_distance=0.0, fog_falloff=0.0)
...
def main():
    ...
    argparser.add_argument('--folder', default='ScenarioLogs', help='Folder with the recorder files (default: ScenarioLogs)')
    argparser.add_argument('--scenario_name', default='None', help='Name of the scenario (default: Accident)')
    ...
    try:
        ...
        #### edit 
        RECORDER_INFO[0]['folder'] = f'{args.folder}/{args.scenario_name}'
        RECORDER_INFO[0]['name'] = args.scenario_name
